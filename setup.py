...
setup(
    ...
    install_requires=['click==6.6', 'requests==2.10.0', 'PyGithub==1.26.0',
                      'jira1.0.7.dev20160607111203', 'GitPython==2.0.7', 'pyteamcity==0.0.1',
                      'pyyaml==3.11', 'keyring==9.3.1', 'autopep8==1.2.4',
                      'semantic_version==2.5.0', 'gcovr==3.2',
                      'teamcity-messages==1.19', 'futures==3.0.5'],
    entry_points='''
        [console_scripts]
        zazu=zazu.core:cli
        '''
